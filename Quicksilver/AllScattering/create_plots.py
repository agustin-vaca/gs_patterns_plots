...
for i in range(10):
    ...
    title="Quicksilver AllScattering, Histogram func=CycleTrackingFunction, Gather",
    ...
    title="Quicksilver AllScattering, Bandwidth func=CycleTrackingFunction, Gather", log_y=True, log_x=True).update_layout(xaxis_title="i", yaxis_title="pattern[i]")
    ...
    title="Quicksilver AllScattering, Deltas func=CycleTrackingFunction, Gather", log_x=True).update_layout(xaxis_title="time", yaxis_title="delta")
    fig.write_html(f"gather_deltas/Gather{i}_deltas.html")

    #Gather delta histogram
    fig = px.histogram(x=gather_delta,
    title="Quicksilver AllScattering, Deltas Histogram func=CycleTrackingFunction, Gather",
    ...
    title="Quicksilver AllScattering, Histogram func=CycleTrackingFunction, Scatter"
    ...
    title="Quicksilver AllScattering, Bandwidth func=CycleTrackingFunction, Scatter").update_layout(xaxis_title="i", yaxis_title="pattern[i]")
    ...
    title="Quicksilver AllScattering, Deltas func=CycleTrackingFunction, Scatter", log_x=True).update_layout(xaxis_title="time", yaxis_title="delta")
    fig.write_html(f"scatter_deltas/Scatter{i}_deltas.html")

    #Gather delta histogram
    fig = px.histogram(x=scatter_delta,
    title="Quicksilver AllScattering, Deltas Histogram func=CycleTrackingFunction, Scatter",
    log_y=True).update_layout(yaxis_title="count", xaxis_title="delta")
